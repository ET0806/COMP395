...
public class Hare : Animal
{
    ...
    {
        //Default: The thickest grass is the one he discovered first.
        ...
        //run to the thickest known grass
    ...
    public override string getAnimalInfo()
    {
        ...
        string format = "{0}: {1}";
        sb.AppendLine();
        sb.AppendFormat(format, "Gender", gender);
        sb.AppendLine();
        sb.AppendFormat(format, "Generation", generation);
        sb.AppendLine();
        sb.AppendFormat(format, "Speed", GetComponent<Movement>().normalSpeed);
        sb.AppendLine();
        sb.AppendFormat(format, "Sprint Speed", GetComponent<Movement>().sprintSpeed);
        return sb.ToString();
